...
msbuild BuildPlugins.msbuild /p:VisualStudioVersion=15.0 /p:VsVersion=15.0 /p:VsFolder=vs17 /p:AssemblyPatcherTaskOn=true /p:EndVSQFile=GitPlugin2017.VSQ /p:SkipCopy=No  > buildlog2017.txt
